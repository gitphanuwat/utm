...
?>
        ...
        <script type="text/javascript">
			$(document).ready(function(){
				$("#showyear").load("pollreport_load.php?action=loadyear");
				$("#showData").load("pollreport_load.php?action=loadpoll");
				//จบ function read
			});
			$(document).on('change','#select_year_id', function() {
				var optionSelected = $("option:selected", this);
  				var idyear = this.value;
				$("#showData").load("pollreport_load.php?action=loadpoll",{idyear:idyear});
			});
