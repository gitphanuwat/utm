...
//var initialLocation;
function getLocationedit() { // ฟังก์ชันแสดงแผนที่
  var old_lat = $("#lat").val();
  var old_lng = $("#lng").val();
  //var old_lat = 17.6282663;
  //var old_lng = 100.0345260;
...
function initialize() {
  var new_lat = $("#lat").val();
  var new_lng = $("#lng").val();
  $("#geo_data").html('<label ><font color="green">ตำแหน่งเดิมของคุณ</font></label>');
