<?php
	...
	if($_GET["action"]=="loadData"){
		if($_GET["id"] !=0){
				...
				*
				from tb_tambon
				where idtambon =" . $_GET["id"] . " order by idtambon";
				$result=mysqli_query($connect,$sql);
					while($row=mysqli_fetch_array($result)){
						echo "<table class='table table-hover'>";
						echo "<tr>";
							echo "<th>ตำบล : $row[2]</th>";
						echo "</tr>";
						echo "<tr>";
						echo "<td>";
						//ตารางรายบุคคล
						...
						and tb_tambon.idtambon =" . $_GET["id"] . " order by tb_user.idmoo,tb_user.firstname";
						$result2=mysqli_query($connect,$sql2);
							if(mysqli_num_rows($result2)==0){
								...
								while($row2=mysqli_fetch_array($result2)){
									...
									echo "<tr>";
										echo "<td>$j</td>";
										echo "<td style=\"width:300px\"><a href='profile.php?id=$row2[2]' target='_blank' >$prefix$row2[4]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$row2[5]</a></td>";
										echo "<td>";
									echo "</tr>";
									$j++;
								}
					...
					echo "</table>";//table1
						...
						where tb_tambon.idtambon = tb_moo.idtambon
						and tb_moo.idmoo = tb_user.idmoo
						order by tb_tambon.idtambon,tb_user.firstname";
						$result2=mysqli_query($connect,$sql2);
						...
						$f="";
							...
							if(mysqli_num_rows($result2)==0){
								...
								while($row2=mysqli_fetch_array($result2)){
									...
									$prefix=$prefix . CreatePrefix($row2[7]);
									if ($f!=$row2[0]){
										echo "<tr><td colspan='3'>ตำบล : $row2[0]</td></tr>";
										//$j=1;
									}
									echo "<tr>";
			...
			echo "<div class='box-footer clearfix'>";
				echo "<div calss='browse_page'>";
					echo "<ul class='pagination pagination-sm no-margin pull-right'>";
						$urlfile="repdata_tambon.php?action=loadData&url=url";
