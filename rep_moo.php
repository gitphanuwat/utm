        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        สรุปรายงานข้อมูล
                        <small>ข้อมูลแยกตามหมู่บ้าน</small>                   </h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li ><a href="#">สรุปรายงาน</a></li>
                        <li class="active">ข้อมูลแยกตามหมู่บ้าน</li>
                    </ol>
              	</section>
                    	...
                    	<div class="col-xs-12">
                        	<div class="box">
                            	<div class="box-header">
                                    <h3 class="box-title">รายการหมู่บ้าน</h3>
                                    <div class="box-tools">
                                ...
                                <div class="box-body table-responsive no-padding">
                               	  <div id="showData" style="margin:auto;padding:10px;">เลือกหมู่บ้านที่ต้องการแสดงข้อมูล</div>
                                    <iframe id="upload_target" name="upload_target" src="#" style="display:none;"></iframe>
                                    <form action="repdata_moo.php?action=insert" method="post" enctype="multipart/form-data" name="form_package"  id="form_package" target="upload_target" onsubmit="clickupload();" >
       ...
       <script src="js/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$("#tambonView").load("repdata_moo.php?action=loadtambon");
				$("#step2").hide();
				$("#box2").slideUp(0);
			...
			function stopUpload(success , error){
				...
				if(success ==1){
					...
					$("#showData").load("repdata_moo.php?action=loadData&id=" + idamphur);
					$("#boxSubwork").hide();
					$("#load").fadeOut();
					...
					if(error==1){
						$("#upload_process").html("<font color='red'>ไม่สามารถบันทึกข้อมูลได้  กรุณาเลือกหลักสูตรก่อน</font>");
						$("#load").fadeOut();
					}else if(error==2){
			...
			$(document).on('click','.delItem', function() {
				...
				if(confirm("ท่านต้องการลบรายการนี้หรือไม่ ?")){
					$("#load").fadeIn();
					$.post("repdata_moo.php?action=delete",{id:id},function(){
						var idamphur = $("#selectDepID").val();
						$("#showData").load("repdata_moo.php?action=loadData&id=" + idamphur);
						$("#boxSubwork").hide();
						$("#load").fadeOut();
			...
			$(document).on('click','.updateItem', function() {
				...
				$.post("repdata_moo.php?action=getupdate",{id:idamphur},function(data){
