...
?>
        ...
        <script type="text/javascript">
			$(document).ready(function(){
				$("#showyear").load("summary_data.php?action=loadyear");
				$("#showData").load("summary_data.php?action=loadamp");
				//จบ function read
				$("#showperson").load("summary_data.php?action=loadperson" ,function(){
					$("#loadperson").fadeOut();
				});
			});
			$(document).on('change','#select_year_id', function() {
				...
				$("#showData").load("summary_data.php?action=loadamp",{idyear:idyear});
				$("#showperson").load("summary_data.php?action=loadperson",{idyear:idyear});
				$("#box1").hide();
				$("#box2").hide()
			});
			...
			$(document).on('click','.getmainwork', function() {
				...
				$("#box1").show();
				$("#box1").load("summary_data.php?action=loadmainwork",{id:idamphur,idyear:idyear});
			});
			...
			$(document).on('click','.getuserwork', function() {
				...
				var idyear = $("#select_year_id").val();
				$("#box2").show();
				$("#box2").load("summary_data.php?action=loaduserwork",{id:idtambon,idyear:idyear});
			});
